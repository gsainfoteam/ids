...
abstract final class IdsTypography {
  ...
  static const body = TextStyle(fontFamily: 'Pretendard Variable', fontSize: 16, fontWeight: FontWeight.w400, height: 1.5, letterSpacing: 0);
  static const label = TextStyle(fontFamily: 'Pretendard Variable', fontSize: 14, fontWeight: FontWeight.w500, height: 1.5, letterSpacing: 0);
  static const caption = TextStyle(fontFamily: 'Pretendard Variable', fontSize: 12, fontWeight: FontWeight.w400, height: 1.5, letterSpacing: 0.5);
}
