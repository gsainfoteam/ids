...
const avatar = tv({
  base: 'inline-flex items-center justify-center rounded-full overflow-hidden shrink-0 bg-(--ids-color-muted) text-(--ids-color-on-muted) font-semibold select-none',
  variants: {
    size: {
      sm: 'size-8 text-xs',
      md: 'size-10 text-sm',
