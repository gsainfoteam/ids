  ...
  return (
    <Tag
      ...
      className={cn(
        ...
        onClick && 'cursor-pointer hover:bg-(--ids-color-muted) transition-colors rounded-xl -mx-2 px-2',
        className,
      )}
    >
      {children}
...
function ItemLeading({ children, className }: { children: ReactNode; className?: string }) {
  return <span className={cn('shrink-0 text-(--ids-color-on-surface)', className)}>{children}</span>;
}
...
function ItemTitle({ children, className }: { children: ReactNode; className?: string }) {
  return <span className={cn('text-label text-(--ids-color-on-surface)', className)}>{children}</span>;
}

function ItemDescription({ children, className }: { children: ReactNode; className?: string }) {
  return <span className={cn('text-caption text-(--ids-color-on-muted)', className)}>{children}</span>;
}

function ItemTrailing({ children, className }: { children: ReactNode; className?: string }) {
  return <span className={cn('shrink-0 text-(--ids-color-on-muted)', className)}>{children}</span>;
}
