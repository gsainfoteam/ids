...
export const Playground: Story = {
  ...
  render: (args) => (
    <div className="h-40 w-full rounded-lg border border-outline p-4">
      <HStack {...args}>
        <Button>첫 번째</Button>
...
export const Alignment: Story = {
  render: () => (
    <HStack gap={12} crossAxis="center">
      <div className="h-16 w-20 rounded-md bg-primary" />
      <div className="h-10 w-20 rounded-md bg-secondary" />
      <div className="h-24 w-20 rounded-md bg-muted" />
    </HStack>
  ),
};
